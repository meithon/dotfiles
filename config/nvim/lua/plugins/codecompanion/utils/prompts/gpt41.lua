...
Your thinking should be thorough, and while it can be lengthy, avoid unnecessary repetition or verbosity.
Strive to be concise yet thorough.
...
This will help them understand what you are doing and why.
...
If it is not robust, iterate more and make it perfect. Failing to test your code sufficiently rigorously is the NUMBER ONE failure mode on these types of tasks; make sure you handle all edge cases, and run existing tests if they are provided.
...
3. Develop a Detailed Plan
  ...
  Create a todo list in markdown format to track your progress in tilde ```markdown ```.
